...
public class SettingsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        saveBtn = findViewById(R.id.saved_settings);
    ...
    private void saveUserData(){
        ...
        if(ImageUri == null){
            userRef.addValueEventListener(new ValueEventListener() {
                ...
                public void onDataChange(DataSnapshot dataSnapshot) {
                    ...
                    if(dataSnapshot.child(FirebaseAuth.getInstance().getCurrentUser().getUid()).hasChild("image")){
                        ...
                        Toast.makeText(SettingsActivity.this, "Set your user profile picture", Toast.LENGTH_SHORT).show();
                    }
                }
            ...
            Toast.makeText(this, "userName is mendatory", Toast.LENGTH_SHORT).show();
        }
        else if (getUserStatus.equals("")){
            Toast.makeText(this, "bio is mendatory", Toast.LENGTH_SHORT).show();
        }
        else {
            ...
            uploadTask.continueWithTask(new Continuation<UploadTask.TaskSnapshot, Task<Uri>>() {
                ...
                public void onComplete(@NonNull Task<Uri> task) {
                    if(task.isSuccessful()){
                        ...
                        profileMap.put("bio", downloadUri);
                        ...
                        userRef.child(FirebaseAuth.getInstance().getCurrentUser().getUid()).updateChildren(profileMap).addOnCompleteListener(new OnCompleteListener<Void>() {
                            ...
                            public void onComplete(@NonNull Task<Void> task) {
                                ...
                                if(task.isSuccessful()){
                                    ...
                                    Toast.makeText(SettingsActivity.this, "Profile Settings update.", Toast.LENGTH_SHORT).show();
                                }
