    ...
    protected void onCreate(Bundle savedInstanceState) {
            ...
            public void onClick(View view) {
                if(continueAndNextBtn.getText().equals("submit") || checker.equals("code sent"))
                {
                    ...
                    if(verificationCode.equals("")){
                        ...
                        loadingBar.setMessage("Please wait, while we are verifying verifing code...");
                ...
                else
                {
                    ...
                    if(!phoneNumber.equals(""))
                    {
                        ...
                        loadingBar.setMessage("Please wait, verifing phone number...");
                        loadingBar.setCanceledOnTouchOutside(false);
                        loadingBar.show();
                    ...
                    {
                        Toast.makeText(RegistrationActivity.this, "Incorect phone no.", Toast.LENGTH_SHORT).show();
                    }
                }
            }
        });
        ...
        mCallbacks = new PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
            ...
            public void onVerificationFailed(FirebaseException e) {
                Toast.makeText(RegistrationActivity.this, "Invalid no...", Toast.LENGTH_SHORT).show();
                loadingBar.dismiss();
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            loadingBar.dismiss();
                            Toast.makeText(RegistrationActivity.this, "Log in successful", Toast.LENGTH_SHORT).show();
                        }
                        else {
                            loadingBar.dismiss();
